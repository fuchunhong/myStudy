...
public class MybatisPlusBuilder {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/chunhongfu/Documents/mp");
        gc.setFileOverride(true);
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(true);// XML columList
        gc.setAuthor("fuchunhong");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/restaurant?characterEncoding=UTF-8&allowMultiQueries=true");
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略,驼峰等

        strategy.setInclude(new String[] { "testing" }); // 需要生成的表

        // strategy.setExclude(new String[]{"test"}); // 排除生成的表

//        strategy.setTablePrefix(new String[] { "cyk_" });
...
//        pc.setParent("io");
        pc.setParent("com.sfa");
        pc.setModuleName("restaurant");
